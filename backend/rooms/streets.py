...
STREETS: tuple[Street, ...] = (
    ...
    # ---- commercial hubs ----
    Street("farmgate", "Farmgate", "area", 23.7580, 90.3894, ("ফার্মগেট", "ফার্ম গেট")),
    Street(
        "motijheel",
        ...
        23.7330,
        90.4170,
        ("Motijheel C/A", "মতিঝিল"),
    ),
    Street("shahbagh", "Shahbagh", "area", 23.7380, 90.3960, ("শাহবাগ",)),
    Street("tejgaon", "Tejgaon", "area", 23.7600, 90.4000, ("তেজগাঁও", "তেজগাঁওথানা")),
    Street("mohakhali", "Mohakhali", "area", 23.7750, 90.4030, ("মোহাখালী", "মহাখালী")),
    Street("nayapaltan", "Nayapaltan", "area", 23.7410, 90.4020, ("নয়াপল্টন", "নয়া পল্টন")),
    Street("eskaton", "Eskaton", "area", 23.7430, 90.3970, ("এস্কাটন",)),
    Street("malibagh", "Malibagh", "area", 23.7540, 90.4050, ("মালিবাগ",)),
    Street("moghbazar", "Moghbazar", "area", 23.7540, 90.3980, ("মগবাজার", "মোগবাজার")),
    Street("rampura", "Rampura", "area", 23.7650, 90.4270, ("রামপুরা",)),
    Street("badda", "Badda", "area", 23.7740, 90.4230, ("বাড্ডা",)),
    # ---- residential areas ----
    Street("dhanmondi", "Dhanmondi", "area", 23.7461, 90.3742, ("ধানমন্ডি", "ধানমোন্ডি")),
    Street("mirpur", "Mirpur", "area", 23.8223, 90.3654, ("মিরপুর",)),
    Street("gulshan", "Gulshan", "area", 23.7808, 90.4152, ("গুলশান",)),
    Street("banani", "Banani", "area", 23.7937, 90.4066, ("বনানী",)),
    Street("mohammadpur", "Mohammadpur", "area", 23.7623, 90.3588, ("মোহাম্মদপুর", "মহম্মদপুর")),
    Street("azimpur", "Azimpur", "area", 23.7226, 90.3874, ("আজিমপুর",)),
    Street("lalmatia", "Lalmatia", "area", 23.7600, 90.3670, ("লালমাটিয়া", "লালমাটিয়া")),
    Street("shyamoli", "Shyamoli", "area", 23.7706, 90.3619, ("শ্যামলী", "শ্যামলি")),
    Street(
        "uttara", "Uttara", "area", 23.8759, 90.3795, ("Uttara Sector 3", "Uttara Sector 7", "উত্তরা")
    ),
    Street("banasree", "Banasree", "area", 23.7700, 90.4320, ("বনশ্রী",)),
    Street("basabo", "Basabo", "area", 23.7550, 90.4300, ("বাসাবো",)),
    Street("kuril", "Kuril", "area", 23.8180, 90.4230, ("Kuril Flyover", "কুড়িল")),
    Street("old_dhaka", "Old Dhaka", "area", 23.7100, 90.4120, ("Bangshal", "পুরান ঢাকা", "পুরানো ঢাকা")),
    Street("bashundhara", "Bashundhara", "area", 23.8150, 90.4270, ("Bashundhara R/A", "বসুন্ধরা")),
    Street("savar", "Savar", "area", 23.8583, 90.2668, ("Savar EPZ", "সাভার")),
    Street("keraniganj", "Keraniganj", "area", 23.6800, 90.3600, ("কেরানীগঞ্জ",)),
    Street("tongi", "Tongi", "area", 23.8900, 90.4050, ("Tongi Bazar", "টঙ্গী", "টঙ্গি")),
    # ---- more roads / lanes ----
    Street(
        "panthapath",
        "Panthapath",
